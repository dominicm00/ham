			...
			for (size_t headSuffix = 0; headSuffix < testDataContextCount;
				...
				for (size_t tailPrefix = 0; tailPrefix < testDataContextCount;
					...
					for (size_t tailSuffix = 0;
						 tailSuffix < testDataContextCount;
						 tailSuffix++) {
...
PathTest::GetFileStatus()
{
	...
	const TestData testData[] = {
		{"", FileStatus::NONE, true},
		{".", FileStatus::DIRECTORY, true},
		{"..", FileStatus::DIRECTORY, false},
		{"foo", FileStatus::FILE, true},
		{"bar", FileStatus::NONE, true},
		{"subdir1/foo", FileStatus::NONE, true},
		{"subdir3/foo", FileStatus::NONE, true},
		{"subdir1/bar", FileStatus::FILE, true},
		{"subdir2/subdir3/foobar", FileStatus::FILE, true},
		{"subdir1/.", FileStatus::DIRECTORY, true},
		{"subdir1/..", FileStatus::DIRECTORY, true},
		{"subdir2/../subdir1/bar", FileStatus::FILE, true},
		{"subdir2/../subdir1/foo", FileStatus::NONE, true},
		{baseDirectory, FileStatus::DIRECTORY, true},
		{baseDirectory + "/.", FileStatus::DIRECTORY, true},
		{baseDirectory + "/..", FileStatus::DIRECTORY, false},
		{baseDirectory + "/foo", FileStatus::FILE, true},
		{baseDirectory + "/bar", FileStatus::NONE, true},
		{baseDirectory + "/subdir1/foo", FileStatus::NONE, true},
		{baseDirectory + "/subdir3/foo", FileStatus::NONE, true},
		{baseDirectory + "/subdir1/bar", FileStatus::FILE, true},
		{baseDirectory + "/subdir2/subdir3/foobar", FileStatus::FILE, true},
		{baseDirectory + "/subdir1/.", FileStatus::DIRECTORY, true},
		{baseDirectory + "/subdir1/..", FileStatus::DIRECTORY, true},
		{baseDirectory + "/subdir2/../subdir1/bar", FileStatus::FILE, true},
		{"baseDirectory + /subdir2/../subdir1/foo", FileStatus::NONE, true},
	};
...
PathTest::PartsPath()
{
	...
	const TestData testData[] = {
		...
		{"root/path/foo.a(archive)",
		 ...
		 ".a",
		 "archive"},
		{"root/some/path/bar.bee(member.o)",
		 "",
		 "root",
		 "some/path",
		 "bar",
		...
		{"<>root/path/foo.a(archive)",
		 ...
		 ".a",
		 "archive"},
		{"<g>root/some/path/bar.bee(member.o)",
		 "<g>",
		 "root",
		 "some/path",
		 "bar",
